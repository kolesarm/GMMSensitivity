...
properties
    ...
    ahat;                   % Matrix used in computing sample sensitivity
...
methods
    ...
    [avg_price, avg_mc] = GetAvgPriceMC(obj, data);
    mean_markup = GetMeanMarkup(obj, data, param);
    [k_xi] = GetWTPDerivative(obj, data);
