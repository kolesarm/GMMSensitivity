...
% Tests GetAvgPriceMC for year 1980, GetMeanMarkup, and GetWTPDerivative
[avg_price, avg_mc] = est.GetAvgPriceMC(data);
disp('Average price and average marginal cost at year 1980:')
disp([avg_price, avg_mc])
mean_markup = est.GetMeanMarkup(data);
disp('Average markup:')
disp([mean_markup])
disp('Derivative of willingness to pay with respect to xi:')
