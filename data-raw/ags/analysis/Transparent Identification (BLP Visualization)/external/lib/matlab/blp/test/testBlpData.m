...
function testGetCarSameFirm()
    test_data = NumbCarsTestData();
    numb_cars = test_data.GetCarsSameFirm();
    assert(length(numb_cars)==length(test_data.var));
    expect_numb_cars = [3 3 3 2 2 1 1 2 2];
    assert(isequal(numb_cars,expect_numb_cars'))
end

function testGetCarRivalFirm()
    test_data = NumbCarsTestData();
    numb_cars = test_data.GetCarsRivalFirm();
    assert(length(numb_cars)==length(test_data.var));
    expect_numb_cars = [2 2 2 3 3 3 3 2 2];
    assert(isequal(numb_cars,expect_numb_cars'))
end

function test_data = NumbCarsTestData()
    test_data_varnames = {'year', 'firm_id'}';
    test_data_var = [1 1 ; ...
                     1 1 ; ...
                     1 1 ; ...
                     1 2 ; ...
                     ...
                     2 3];
    test_data = data;
    test_data.var = dataset([{test_data_var}, test_data_varnames']);
end
