...
$K=\sqrt{\# I}$, where $\#I$ is the number of invalid instruments (using the
scaling described in the paper). Then the confidence interval can be constructed
as follows:
